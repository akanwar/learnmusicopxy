...
Corrections and improvements are very welcome — especially from people who actually own and play
an OP–XY.
...
Small fixes (typos, a wrong step number, a broken link) can also just be an
[issue](https://github.com/akanwar/learnmusicopxy/issues) if a PR is too much ceremony.

## Ground rules

- **The device is the source of truth.** If a claim can't be traced to the official
  [OP–XY guide](https://teenage.engineering/guides/op-xy) or verified on real hardware, say so
  in the text.
...
- By contributing you agree your content contributions are licensed CC BY 4.0 and code
  contributions MIT, matching the repo.
